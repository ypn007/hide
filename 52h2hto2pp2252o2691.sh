...
echo "  ${GR}  ==[ Tools Name : PUBG GRASS HIDER"
echo "  ${GR}  ==[ Coded by : Yell Phone Naing"
echo "   ${ORANGE} ==[ Version : 1.0.0"
echo "  ${PURPLE}  ==[ Program Type :Shell"
sleep 2
echo "${GR}Cutting Grass With Grass Cutter"
sleep 3
echo "${GR}Please Wait Almost To Finish"
sleep 5
cp 5 /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks
cd /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks
rm game_patch_0.17.0.11802.pak
mv 5 game_patch_0.17.0.11802.pak
sleep 4
echo "${GR} Cutted All Grass Successfully"
exit